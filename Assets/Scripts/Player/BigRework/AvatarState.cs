...
namespace AvatarModel
{
    public class AvatarState
    {
        ...
        {
            _avatar = avatar;
            _rigidbody = _avatar.GetComponent<Rigidbody>();
        ...
        private RunData GetRunData()
        {
            ...
            return new RunData(_avatar.transform.TransformVector(convertedVector) * AvatarStats.RunSpeed);
        }
        ...
        private FlyData GetFlyData()
        {
            ...
            return new FlyData(_flyDirection, AvatarStats.FlySpeedLimit);
        }


        private RunOnSlopeData GetRunOnSlopeData()
        {
            var convertedVector = _avatar.transform.TransformVector(new Vector3(MoveDirection.x, 0f, MoveDirection.y));
            convertedVector = Vector3.ProjectOnPlane(convertedVector, _slopeHit.normal).normalized * AvatarStats.RunSpeed;
            ...
            private void InitializeLayers1_5()
            {
                _stateSet.Add(
                   ...
                   (
                       ...
                       delegate () { _avatarState._rigidbody.useGravity = true; return; }));
                ...
                _stateSet.Add(
                   ...
                   (
                       ...
                       delegate () { _avatarState._rigidbody.useGravity = false; return; }));
            ...
            private void InitializeLayers6_10()
            {
                _stateSet.Add(
                   ...
                   (
                       ...
                       delegate () { _avatarState._lockedVelocity = _avatarState._rigidbody.velocity; }));
            }
